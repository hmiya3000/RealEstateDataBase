...
//  RealEstateDataBase
//
//  Created by hmiya on 2016/03/26.
...
@implementation OpeTipsViewCtrl
#define BTAG_CLOSE  1
...
-(void)viewDidLoad {
    ...
    NSString *path = [[NSBundle mainBundle] pathForResource:@"OpeTips" ofType:@"html"];
