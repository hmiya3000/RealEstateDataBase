...
- (void)viewDidLoad
{
    ...
    /****************************************/
    _l_loanBorrow   = [UIUtil makeLabel:[NSString stringWithFormat:@"%ld万円",(long)_value]];
...
- (void)viewMake
{
    ...
    if ( _pos.isPortrait == true ){
        ...
        pos_y = pos_y + dy;
        [UIUtil setLabel:_l_selfFinance     x:pos_x         y:pos_y length:_pos.len10/2];
        [UIUtil setLabel:_l_selfFinanceVal  x:pos_x+dx      y:pos_y length:_pos.len10/2];
        pos_y = pos_y + dy;
...
{
    _value              = value;
    _l_loanBorrow.text  = [NSString stringWithFormat:@"%ld万円",(long)_value];
