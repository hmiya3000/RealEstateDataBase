...
-(void)viewDidLoad
{
    ...
    _value  = _modelRE.investment.gpi/10000;
...
{
    if ( _b_cancel == false ){
        _modelRE.investment.gpi         = _value*10000;
        [_modelRE valToFile];
    }
...
-(void) enterIn:(CGFloat)value
{
    ...
    _l_priceVal.text    = [NSString stringWithFormat:@"%@万円",[UIUtil yenValue:_modelRE.investment.price/10000]];
    _l_interestVal.text = [NSString stringWithFormat:@"%2.2f%%",(float)_value*10000/_modelRE.investment.price*100 ];
