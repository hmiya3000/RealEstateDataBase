...
- (void)viewDidLoad
{
    ...
    _value  = _modelRE.estate.prices.price /10000;
    ...
    /****************************************/
    _l_price        = [UIUtil makeLabel:[NSString stringWithFormat:@"%ld 万円",(long)_modelRE.estate.prices.price/10000]];
    ...
    _l_inputArea    = [UIUtil makeLabel:@"100"];
    [_scrollView addSubview:_l_inputArea];
...
- (void)viewMake
{
    ...
    if ( _pos.isPortrait == true ){
        ...
        pos_y = pos_y + dy;
        [UIUtil setLabel:_l_inputArea x:pos_x y:pos_y length:_pos.len30];
        pos_y = pos_y + dy;
