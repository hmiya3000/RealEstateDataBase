...
-(void)rewriteProperty
{
    ...
    _l_priceVal.text    = [NSString stringWithFormat:@"%4.1f万円",(float)_modelRE.investment.price/_value/10000];
    _l_areaVal.text     = [NSString stringWithFormat:@"%2.1f㎡",(float)_modelRE.estate.house.area/_value];
    _l_incomeVal.text   = [NSString stringWithFormat:@"%2.1f万円",(float)_modelRE.investment.gpi/_value/12/10000];
}
