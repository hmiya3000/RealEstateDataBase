...
//
//======================================================================
+ (NSString*)getJpnYearShort:(NSInteger)year
{
    if ( year > 1989 ){
        return [NSString stringWithFormat:@"H.%d",(int)year- 1988];
    } else if ( year == 1989 ){
        return [NSString stringWithFormat:@"H.1"];
    } else if (year > 1926 ){
        return [NSString stringWithFormat:@"S.%d",(int)year- 1925];
    } else if (year == 1926 ){
        return [NSString stringWithFormat:@"S.1"];
    } else if (year > 1912 ){
        return [NSString stringWithFormat:@"T.%d",(int)year- 1911];
    } else if (year == 1911 ){
        return [NSString stringWithFormat:@"T. 1"];
    } else {
        return [NSString stringWithFormat:@"M.%d",(int)year- 1867];
    }
}
//======================================================================
//
//======================================================================
+ (NSString*)getYearShort:(NSInteger)year
{
    if ( year >= 2000 ){
        return [NSString stringWithFormat:@"'%02d",(int)year-2000];
    } else if ( year >= 1900 ){
        return [NSString stringWithFormat:@"'%02d",(int)year-1900];
    } else {
        return [NSString stringWithFormat:@"'%02d",(int)year-1800];
    }
}
//======================================================================
//
...
+(NSString*)removePrefix:(NSString*)prefix targetStr:(NSString*)targetStr
{
    ...
    found = [targetStr rangeOfString:prefix options:NSLiteralSearch];
    if (found.location != NSNotFound && found.location==0 ){
        //先頭に見つけた
        removedStr = [targetStr substringFromIndex:found.location + found.length];
    } else {
        //先頭以外で見つけた or 見つからなかった
        removedStr = @"";
    }
    return removedStr;
}
...
//
//======================================================================
+ (NSInteger)getTerm_year:(NSInteger)year month:(NSInteger)month
{
...
//
//======================================================================
+ (NSInteger)getYear_term:(NSInteger)term
{
    return (NSInteger)(term / 12);
}
//======================================================================
//
//======================================================================
+ (NSInteger)getMonth_term:(NSInteger)term
{
    return (NSInteger)(term % 12 + 1);
}
